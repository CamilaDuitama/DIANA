...
# Minimum samples required to plot a class in ROC/PR curves
MIN_SAMPLES_FOR_CURVE = 5  # Classes with fewer samples will be excluded from plots
...
def plot_roc_pr_curves(
    ...
    for i in range(n_classes):
        ...
        if n_samples >= MIN_SAMPLES_FOR_CURVE:
