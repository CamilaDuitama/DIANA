...
\input{tables/final/sup_table_01_class_distribution.tex}

\begin{table}[p]
    \input{tables/final/sup_table_02_unseen_labels.tex}
\end{table}

\begin{table}[p]
    \input{tables/final/sup_table_03_perclass_performance.tex}
\end{table}

\begin{table}[p]
    \input{tables/final/sup_table_04_hyperparameters.tex}
\end{table}

% Sup Table 05: Wrong Predictions (longtable - no table wrapper needed)
\input{tables/final/sup_table_05_wrong_predictions_merged.tex}

\begin{table}[p]
    \input{tables/final/sup_table_06_blast_summary.tex}
\end{table}

% Sup Table 07: Seen/Unseen Validation (longtable - no table wrapper needed)
\input{tables/final/sup_table_07_seen_unseen_validation.tex}

\begin{table}[p]
    \input{tables/final/sup_table_08_matrix_generation.tex}
\end{table}
