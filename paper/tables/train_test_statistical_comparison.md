...
**Test Methods**:
- **Categorical variables**: Chi-squared test (or Fisher's exact test for small counts)
- **Numeric variables**: Kolmogorov-Smirnov test (2-sample)

**Interpretation**:
- **Significant = Yes**: The distributions differ significantly (p < 0.05)
- **Significant = No**: No evidence of significant difference (p ≥ 0.05)

---

## Summary

- **Significant differences**: 1 / 46 variables
- **Non-significant**: 43 / 46 variables
- **Insufficient data / Not testable**: 2 / 46 variables
...
| Variable | Type | Test | Statistic | P-value | Significant (α=0.05) | Note |
|----------|------|------|-----------|---------|----------------------|------|
| True_label | Categorical | Chi-squared (warning: low counts) | 66.1420 | 0.1905 | No |  |
| sample_type | Categorical | Chi-squared | 0.0405 | 0.8404 | No |  |
| status | Categorical | Only one category | N/A | N/A | N/A | Only one category |
| sample_name | Categorical | Chi-squared (warning: low counts) | 1761.8162 | 0.6223 | No |  |
| project_name | Categorical | Chi-squared (warning: low counts) | 67.5222 | 0.8912 | No |  |
| publication_year | Numeric | Kolmogorov-Smirnov | 0.0338 | 0.7872 | No |  |
| geo_loc_name | Categorical | Chi-squared (warning: low counts) | 49.8216 | 0.8227 | No |  |
| material | Categorical | Chi-squared | 6.4779 | 0.8901 | No |  |
| sample_host | Categorical | Chi-squared (warning: low counts) | 22.0951 | 0.0236 | Yes |  |
...
| Assay Type | Categorical | Chi-squared (warning: low counts) | 0.7601 | 0.6838 | No |  |
| BioProject | Categorical | Chi-squared (warning: low counts) | 29.1009 | 0.4598 | No |  |
| BioSample | Categorical | Chi-squared (warning: low counts) | 266.9592 | 0.7025 | No |  |
| Center Name | Categorical | Chi-squared (warning: low counts) | 27.6731 | 0.2284 | No |  |
| Consent | Categorical | Only one category | N/A | N/A | N/A | Only one category |
| DATASTORE filetype | Categorical | Chi-squared (warning: low counts) | 2.9233 | 0.7118 | No |  |
| DATASTORE provider | Categorical | Chi-squared (warning: low counts) | 1.6177 | 0.8056 | No |  |
| DATASTORE region | Categorical | Chi-squared (warning: low counts) | 2.4289 | 0.7872 | No |  |
| Experiment | Categorical | Chi-squared (warning: low counts) | 318.0059 | 0.4894 | No |  |
| Instrument | Categorical | Chi-squared (warning: low counts) | 9.6280 | 0.2107 | No |  |
| LibraryLayout | Categorical | Chi-squared | 0.8580 | 0.3543 | No |  |
| LibrarySelection | Categorical | Chi-squared (warning: low counts) | 3.5083 | 0.6221 | No |  |
| LibrarySource | Categorical | Fisher's exact (p=0.1401) | N/A | 0.1401 | No |  |
| Organism | Categorical | Chi-squared (warning: low counts) | 3.8716 | 0.8685 | No |  |
| Platform | Categorical | Fisher's exact (p=1.0000) | N/A | 1.0000 | No |  |
| ReleaseDate | Categorical | Chi-squared (warning: low counts) | 37.1586 | 0.3256 | No |  |
| SRA Study | Categorical | Chi-squared (warning: low counts) | 29.1009 | 0.4598 | No |  |
| Type | Categorical | Chi-squared | 0.3045 | 0.5811 | No |  |
| Isolation source | Categorical | Chi-squared (warning: low counts) | 6.9423 | 0.4349 | No |  |
